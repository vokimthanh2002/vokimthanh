...
<form method="post">
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input name="maBN" type="text" class="form-control"  placeholder="Nhap ma benh nhan">
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input name="tenBN" type="text" class="form-control"  placeholder="Nhap ten benh nhan">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <input name="lyDo" type="text" class="form-control"  placeholder="Nhap ly do">
        </div>
